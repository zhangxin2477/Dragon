...
public class DirectoryAction extends ActionSupport {
	...
	public String getSdir(){
		try {
			if (sdir_page != null) {
				sdir_page = directoryServiceInterface.getSDir(sdir_page.getPageNow());
			} else {
	...
	public void setDirectoryServiceInterface(DirectoryServiceInterface directoryServiceInterface) {
